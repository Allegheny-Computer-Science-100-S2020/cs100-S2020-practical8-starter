# cs100-S2020-practical8-starter
...
the `PasswordCheckerMain` file must also pass additional tests set by the
[GatorGrader tool](https://github.com/gkapfham/gatorgrader).
...
- The command output has exactly 1 of the `Okay, I read in the password` fragment
- The command output has exactly 1 of the `valid password? No` fragment
- The command output has exactly 2 of the `computerscience2020` fragment
- The command output has exactly 5 lines
- The file PasswordChecker.java exists in the src/main/java/practicaleight directory
- The file PasswordCheckerMain.java exists in the src/main/java/practicaleight directory
- The PasswordChecker.java in src/main/java/practicaleight has at least 2 multiple-line Java comment(s)
- The PasswordChecker.java in src/main/java/practicaleight has at least 4 single-line Java comment(s)
- The PasswordChecker.java in src/main/java/practicaleight has exactly 0 of the `Add Your Name Here` fragment
- The PasswordChecker.java in src/main/java/practicaleight has exactly 0 of the `print(` fragment
- The PasswordChecker.java in src/main/java/practicaleight has exactly 0 of the `println(` fragment
- The PasswordChecker.java in src/main/java/practicaleight has exactly 0 of the `TODO` fragment
- The PasswordChecker.java in src/main/java/practicaleight has exactly 1 of the `package practicaleight;` fragment
- The PasswordCheckerMain.java in src/main/java/practicaleight has at least 1 of the `println(` fragment
- The PasswordCheckerMain.java in src/main/java/practicaleight has at least 2 multiple-line Java comment(s)
- The PasswordCheckerMain.java in src/main/java/practicaleight has at least 4 single-line Java comment(s)
- The PasswordCheckerMain.java in src/main/java/practicaleight has exactly 0 of the `Add Your Name Here` fragment
- The PasswordCheckerMain.java in src/main/java/practicaleight has exactly 0 of the `TODO` fragment
- The PasswordCheckerMain.java in src/main/java/practicaleight has exactly 1 of the `package practicaleight;` fragment
...
```
        ┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓
        ┃ Passed 22/22 (100%) of checks for cs100-S2020-practical8! ┃
        ┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛
```
...
```
git remote add download git@github.com:Allegheny-Computer-Science-100-S2020/cs100-S2020-practical8-starter.git
```
...
5](https://github.com/Allegheny-Computer-Science-100-S2020/cs100-S2020-practical8-starter)
repository and [raise an
issue](https://github.com/Allegheny-Computer-Science-100-S2020/cs100-S2020-practical8-starter/issues).
